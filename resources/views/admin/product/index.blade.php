                            ...
                            <div class="row">
                               <!-- ten san pham -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="storage" name="storage" required value="TEN SAN PHAM">
                                </div>
                                <!-- screen -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">SCREEN</label>
                                    <input class="form-control" type="text" id="screen" name="screen" required value="TEN SAN PHAM">
                                </div>
                                <!-- card -->
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="connector" name="connector" required value="TEN SAN PHAM">
                                </div>
                                <!-- weight -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">WEIGHT</label>
                                    <input class="form-control" type="text" id="weight" name="weight" required value="TEN SAN PHAM">
                                </div>
                                <!-- keyboard -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">KEYBOARD</label>
                                    <input class="form-control" type="text" id="keyboard" name="keyboard" required value="TEN SAN PHAM">
                                </div>
                                <!-- battery -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">BATTERY</label>
                                    <input class="form-control" type="text" id="battery" name="battery" required value="TEN SAN PHAM">
                                </div>
                                <!-- os -->
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="warranty" name="warranty" required value="TEN SAN PHAM">
                                </div>
                                <!-- color -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">COLOR</label>
                                    <input class="form-control" type="text" id="color" name="color" required value="TEN SAN PHAM">
                                </div>                                
                                <!-- material -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">MATERIAL</label>
                                    <input class="form-control" type="text" id="material" name="material" required value="TEN SAN PHAM">
                                </div>
                                <!-- price -->
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="form-control" id="description" name="description" required>value="TEN SAN PHAM"</textarea>
                                </div>
                                <!-- image -->
                                <div class="form-group col-12">
                        ...
                        <form action="{{ route('admin.product.update', ['id' => $p->id]) }}" method="POST">
                            ...
                            <div class="row">
                               <!-- ten san pham -->
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label">WARRANTY</label>
                                    <input class="form-control" type="text" id="warranty" name="warranty" required value="{{$p->warranty}}">
                                </div>
                                <!-- color -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">COLOR</label>
                                    <input class="form-control" type="text" id="color" name="color" required value="{{$p->color}}">
                                </div>                                
                                <!-- material -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">MATERIAL</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label">PRICE</label>
                                    <input class="form-control" type="number" id="price" name="price" required value="{{$p->price}}">
                                </div>                               
                                <!-- stock -->
                                <div class="form-group col-md-6">
                                    <label class="control-label">STOCK</label>
                                    <input class="form-control" type="number" id="stock" name="stock" required value="{{$p->stock}}">
                                </div>
