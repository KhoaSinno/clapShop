        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="login100-form validate-form">
                    ...
                    <form action="{{ route('checkotp.checkotp') }}" method="post">
                        @include('admin.alert')
                        <div class="wrap-input100 validate-input">
                            <input class="input100" type="text" placeholder="Nhập OTP đã gửi trong email" name="otp"
                                id="username">
                        ...
                        <div class="container-login100-form-btn">
                            <button type="submit" class="btn btn-info w-100">Xác nhận mã OTP</button>
                        </div>
